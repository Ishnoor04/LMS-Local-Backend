...
exports.generateVideoUrl = exports.getAllCoursesAdmin = exports.deleteCourse = exports.addReplyToReview = exports.addReview = exports.addAnswer = exports.addQuestion = exports.getCourseByUser = exports.getAllCourses = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = void 0;
...
exports.getSingleCourse = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isCacheExist) {
            ...
            await redis_1.redis.set(req.params.id, JSON.stringify(course), "EX", 604800); //7days expiry
            res.status(200).json({
                success: true,
                course,
            });
...
exports.addAnswer = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const { answer, courseId, questionId, contentId } = req.body;
        const course = await course_model_1.default.findById(courseId);
        if (!mongoose_1.default.Types.ObjectId.isValid(contentId)) {
            return next(new ErrorHandler_1.default("Invalid content id", 400));
        }
        ...
        if (req.user?._id === question?.user._id) {
            ...
            const html = await ejs_1.default.render(path_1.default.join(__dirname, "../mails/question-mail.ejs"), data);
            try {
