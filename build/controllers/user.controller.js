...
exports.deleteUser = exports.updateUserRoles = exports.getAllUsers = exports.addCourseToUser = exports.updateProfilePicture = exports.updateUserPassword = exports.updateUserInfo = exports.socialAuth = exports.getUserInfo = exports.updateAccessToken = exports.logoutUser = exports.loginUser = exports.activateUser = exports.registrationUser = void 0;
...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isEmailExist) {
            return next(new ErrorHandler_1.default("Email already present", 400));
        }
        const user = {
            name,
            email,
        ...
        const html = await ejs_1.default.render(path_1.default.join(__dirname, "../mails/activation-mail.ejs"), data);
        try {
...
const createActivationToken = (user) => {
    ...
    const token = jsonwebtoken_1.default.sign({ user, activationCode }, process.env.ACTIVATION_SECRET, { expiresIn: "1h" });
...
exports.activateUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const existUser = await user_model_1.default.findOne({ email: saveUser.email });
        if (existUser) {
            return next(new ErrorHandler_1.default("Email already exists", 400));
        }
        const user = await user_model_1.default.create(saveUser);
...
exports.updateAccessToken = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        await redis_1.redis.set(user._id, JSON.stringify(user), "EX", 604800); //604800 -> 7 days
        next();
    }
    catch (error) {
        return next(new ErrorHandler_1.default(error.message, 400));
...
exports.updateUserPassword = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (user?.password === undefined) {
            return next(new ErrorHandler_1.default("Invalid password change request", 400));
        }
        const isPasswordMatch = await user?.comparePassword(oldPassword);
        console.log(isPasswordMatch);
        if (oldPassword === newPassword) {
            return next(new ErrorHandler_1.default("New Password cannot be same as Old password", 400));
        }
        if (!isPasswordMatch) {
...
//update user roles
exports.updateUserRoles = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
