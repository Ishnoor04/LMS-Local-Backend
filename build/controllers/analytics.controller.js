...
exports.getOrderAnalytics = exports.getNotificationAnalytics = exports.getCourseAnalytics = exports.getUserAnalytics = void 0;
...
//get notification analytics -- only for admin
exports.getNotificationAnalytics = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const notifications = await (0, analytics_generator_1.generateLast12MonthsData)(notificationModel_1.default);
        res.status(200).json({
            success: true,
            notifications,
        });
